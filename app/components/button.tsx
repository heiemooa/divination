...
function Button({onClick, value, className, disable = false, buttonColor = stoneColor}: ButtonProps) {
  return (
    <button className={clsx(buttonColor.bg, buttonColor.ring, `hover:${buttonColor.hover}`,
      "rounded-md shadow-md px-3 py-1 text-white transition",
      "disabled:opacity-65 disabled:cursor-progress",
      "enabled:hover:shadow-lg enabled:hover:-translate-y-0.5",
